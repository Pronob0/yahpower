        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-end">
                    <a href="{{ route('admin.video.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>
                        @lang('Add New')</a>
                </div>
                    ...
                    <table class="table align-items-center table-striped">
                        ...
                        @forelse ($videos as $item)
                            <tr>
                                ...
                                <td data-label="{{ __('Video') }}">
                                    <iframe width="100" height="100" src="{{ $item->video }}">
                                    </iframe>
                                ...
                                <td data-label="{{ __('Action') }}">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-danger  btn-sm remove mb-1"
                                        data-route="{{ route('admin.video.destroy', $item) }}" data-toggle="tooltip"
