   ...
   <div class="col-md-12">
      ...
      <div class="card mb-4">
         ...
         <div class="card-body">
            ...
            <form action="{{route('admin.helio.store')}}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="col-md-12 ShowImage mb-3  text-center d-none" id="is_image">
                ...
                <div class="form-group" id="video">
                    ...
                    <input type="text" class="form-control" name="video" id="video"  placeholder="{{ __('video Link') }}" value="{{old('link')}}">
                    <small>Please use embed link from youtube</small>
                </div>
                
                 <div class="col-md-6 d-none" id="image">
                        <div class="form-group">
