...
@section('breadcrumb')
 <section class="section">
    <div class="section-header  d-flex justify-content-between">
        ...
        <a href="{{route('admin.slider.index')}}" class="btn btn-primary"><i class="fas fa-backward"></i> @lang('Back')</a>
    </div>
</section>
@endsection
@section('content')
         ...
         <div class="card-body">
            ...
            <form action="{{route('admin.slider.update',$slider->id)}}" enctype="multipart/form-data" method="POST">
                ...
                <div class="col-md-12 ShowImage mb-3  text-center">
                    <img src="{{ getPhoto($slider->photo) }}" class="img-fluid" alt="image" width="400">
                 </div>
