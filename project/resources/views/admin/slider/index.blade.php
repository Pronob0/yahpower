                        ...
                        @forelse ($sliders as $item)
                            <tr>
                                ...
                                <td data-label="{{ __('Image') }}">
                                    <img width="400" src="{{ getPhoto($item->photo) }}" alt="">
                                </td>
                                ...
                                <td data-label="{{ __('Is Banner') }}">
                                    ...
                                    <div class="btn-group mb-2">
                                        ...
                                        <div class="dropdown-menu">
                                          <a class="dropdown-item" href="{{route('admin.slider.status',[$item->id,1])}}">Yes</a>
                                        </div>
                                      </div>
                                    @endif
                                ...
                                <td data-label="{{ __('Action') }}">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-danger  btn-sm remove mb-1"
                                        data-route="{{ route('admin.slider.destroy', $item) }}" data-toggle="tooltip"
